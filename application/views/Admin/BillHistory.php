...
<head>
    ...
    <style>
        h2 { text-align: center; color: #a86d01ff; font-weight: bold; margin-bottom: 2rem; }
        .form-control:focus, .form-select:focus { box-shadow: none; color: #a86d01ff; }
        .btn-gold { background: linear-gradient(90deg, #B37B16, #FFD27F); color: #000; font-weight: 600; border: none; transition: all .3s ease; }
        .btn-gold:hover { background: linear-gradient(90deg, #FFD27F, #B37B16); box-shadow: 0 4px 8px rgba(0,0,0,.1); }
        .btn-black { background: #111; color: #FFD27F; font-weight: 600; border: none; transition: all .3s ease; }
        .btn-black:hover { background: #FFD27F; color: #111; box-shadow: 0 4px 8px rgba(0,0,0,.1); }
        .table th { color: #a86d01ff; }
    </style>
</head>
<body>
<div class="d-flex">
