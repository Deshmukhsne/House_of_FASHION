...
<head>
    ...
    <style>
        ...
        .card-header { background-color: #000; color: #FFD27F; font-weight: 600; }
        .btn-gold { background: linear-gradient(90deg, #B37B16 0%, #FFD27F 100%); color: #000; font-weight: 600; }
        .btn-gold:hover { background: linear-gradient(90deg, #e2a93e, #f7c872, #e1aa46); color: #000; }
        .modal-header { background-color: #000; color: #FFD27F; }
        .table th { background-color: #343a40; color: #FFD27F; }
        .main { width: 100%; overflow-x: auto; }
        .table-container { overflow-x: auto; width: 100%; }
        @media (max-width: 768px) {
            .card-header { flex-direction: column; align-items: flex-start; gap: 10px; }
            .card-header h4 { font-size: 1.2rem; }
            .search-form .col-md-4, .search-form .col-md-3 { width: 100%; max-width: 100%; flex: 0 0 100%; }
            .table th, .table td { white-space: nowrap; font-size: 0.85rem; padding: 0.5rem; }
            .action-buttons { display: flex; flex-wrap: nowrap; }
        }
        @media (max-width: 576px) {
            .modal-dialog { margin: 0.5rem; }
            .modal-body .col-md-6, .modal-body .col-md-12 { flex: 0 0 100%; max-width: 100%; }
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-buttons">
                                                    <button class="btn btn-sm btn-warning editBtn me-1"
                                                        ...
                                                        data-experience="<?= $tailor['experience'] ?>"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="<?= base_url('Tailors/create') ?>" method="post" class="modal-content">
                            ...
                            <div class="modal-body row g-2">
                                ...
                                <div class="col-12 col-md-6"><input type="number" name="experience" class="form-control" placeholder="Experience (Years)" required></div>
                        ...
                        <form id="editTailorForm" method="post">
                            <div class="modal-content">
                                ...
                                <div class="modal-body row g-3">
                                    ...
                                    <div class="col-12 col-md-6"><label>Experience</label><input type="number" class="form-control" name="experience" id="edit_experience" required></div>
