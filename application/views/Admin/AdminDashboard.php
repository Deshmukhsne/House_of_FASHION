                                ...
                                <div class="card p-3">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h3 class="stat-number">₹<?php echo number_format($total_revenue, 2); ?>
                                            </h3>
                                        </div>
                                ...
                                <div class="card p-3">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h3 class="stat-number">₹<?php echo number_format($total_stock_value, 2); ?>
                                            </h3>
                                ...
                                <div class="card p-3">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h3 class="stat-number">₹<?php echo number_format($total_deposits, 2); ?>
                                            </h3>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card h-100">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="<?= base_url('AdminController/BillHistory') ?>"
